...
const navItems = [
  ...
  { to:'/biometric',icon:Fingerprint,label:'Biometric', access:['ADMIN'] },
  { to:'/plans',icon:ClipboardList,label:'Plans', access:['ADMIN'] },
  { to:'/trainers',icon:Dumbbell,label:'Trainers', access:['ADMIN'] },
  { to:'/staff',icon:UserCog,label:'Staff', access:['ADMIN'] },
